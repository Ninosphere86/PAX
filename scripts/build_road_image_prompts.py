...
SPECIAL_NOTES = {
    ...
    "R12_01": "Expressway-lane-change invariant: show a passenger car still centered in its original expressway lane with the appropriate turn indicator already flashing. The driver checks mirrors and a clearly open adjacent-lane gap before beginning a gradual lane change.",
    "R12_02": "Forced-merge-response invariant: show a car from the RIGHT lane forcing diagonally left into the test vehicle's lane. The test vehicle remains behind, visibly decelerates, and opens a safe gap so the right-front car can merge. No collision or aggressive blocking.",
    "R12_03": "Red-car invariant: show a red car beside or just ahead in the target lane while the test vehicle stays behind and does not accelerate across its path. The test vehicle slows and waits for a later safe gap.",
    "R12_04": "Signal-required invariant: even though the adjacent lane and rear view are clear, show the test vehicle activating its turn indicator BEFORE leaving its lane. Do not depict an unsignaled lane change.",
    "R12_05": "Right-vehicle-merge invariant: show a vehicle from the right lane moving left into the test vehicle's lane. The test vehicle reduces speed, stays behind, and preserves a safe following gap.",
    "R12_06": "Post-overtake-gap invariant: show the overtaking car remaining in the left lane until it is several car lengths ahead of the passed vehicle. It has not yet cut back immediately; returning right happens only after a safe gap is established.",
    "R12_07": "Observation-before-change invariant: show the vehicle still in its original lane with its indicator on while the driver checks the side mirror and blind spot. The adjacent lane contains another vehicle, so the lane change has not begun.",
    "R12_08": "No-abrupt-change invariant: show the vehicle signaling early and waiting centered in its lane for a safe gap. Do not depict a sudden sharp steering movement or immediate cut.",
    "R12_09": "One-lane-at-a-time invariant: use a high rear-oblique view and show exactly THREE same-direction travel lanes total, bounded by the left and right road edges and separated by exactly TWO dashed white dividers. No fourth lane, shoulder lane, bus lane, or auxiliary lane. The test vehicle starts in the far-right lane and moves only into the middle lane, crossing only the right-hand dashed divider; it never touches the left-hand divider.",
    "R12_10": "Solid-line-zone invariant: immediately before an intersection, show a long solid white lane line. The test vehicle stays fully within its current lane before the solid line and does not cross or straddle it.",
    "R12_11": "No-interference invariant: show a signaled gradual lane change only after a large safe gap opens in the adjacent lane. Other vehicles continue normally without braking or swerving.",
    "R12_12": "A-car solid-line violation invariant: use a high rear-oblique view. Mark the test vehicle with one large Latin letter A. A is visibly straddling an unbroken solid white lane line while trying to move into a left-turn lane, making the illegal solid-line lane change unmistakable. No B marker.",
    "R12_13": "A-car solid-line violation invariant: use a high rear-oblique view. Mark the test vehicle with one large Latin letter A. A is visibly straddling an unbroken solid white lane line during a lane change, making the violation unmistakable. No B marker.",
    "R12_14": "No-interference invariant: show a gradual signaled lane change into a large open gap while nearby vehicles maintain normal speed and direction. No vehicle brakes, swerves, or is forced aside.",
    "R12_15": "Left-indicator invariant: use a close rear three-quarter view of a car still centered in its original lane. Its LEFT rear amber indicator is clearly flashing before any leftward lane movement.",
    "R12_16": "Advance-signal invariant: show the turn indicator already flashing while the vehicle remains fully centered in the original lane before the lane-change maneuver begins. Do not show the signal first appearing mid-change.",
    "R12_17": "Communication invariant: show the test vehicle still in its lane with the turn indicator flashing, clearly visible to both a following vehicle and a vehicle in the target lane before any movement.",
    "R12_18": "A-car side-by-side invariant: mark the test vehicle with one large Latin letter A. A remains in the right lane while another vehicle is exactly alongside in the left lane, occupying A's blind-spot area. A must not move left or cross the dashed divider.",
}
